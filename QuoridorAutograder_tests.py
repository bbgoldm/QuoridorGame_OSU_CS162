...
class TestQuoridorGame(unittest.TestCase):
        ...
        def test_1501(self):
            ...
            q.move_pawn(1, (4,7)) #move horizontally so P2 gets enough turns to fence
            q.place_fence(2, 'h', (7,8)) 

            q.move_pawn(1, (5,7)) #move horizontally so P2 gets enough turns to fence
        ...
        def test_1502(self):
            ...
            q.place_fence(2, 'h', (2,4)) #northern fence

            q.place_fence(1, 'v', (7,2)) #dumb move to pass
            last_blocking_fence_placement_move = q.place_fence(2, 'h', (3,4)) #southern fence block that would trap p2
